...
if (menu=='Решение совместной задачи термоупругости'):
    ...
    В проекте рассматривается стационарная линейная система уравнений для температуры и перемещений
    описывающая термоупругое состояние тела и возникающие в ней напряжения. В качестве модельной задачи
    рассмотрено напряженное состояние возникающее в двухслойной пластине под воздействием температурных 
    полей
    ## Проект команды №3
