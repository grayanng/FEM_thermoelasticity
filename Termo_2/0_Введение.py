...
menu = st.sidebar.radio('***',
    (
    'Решение совместной задачи термоупругости 2D образца',
     'Мотивация')
)
if (menu=='Решение совместной задачи термоупругости 2D образца'):
    ...
    ### Решение совместной задачи термоупругости 2D образца, подверженному  стационарному нагреву, с использованием FEniCS 
