...
class _ReadPandasMixin(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pyarrow.lib', 'read_pandas': <cyfunction _ReadPandasMixin.read_pandas at 0x000001971BF9A520>, '__dict__': <attribute '__dict__' of '_ReadPandasMixin' objects>, '__weakref__': <attribute '__weakref__' of '_ReadPandasMixin' objects>, '__doc__': None})"
