...
class FlightCancelledError(FlightError, __pyarrow_lib.ArrowCancelled):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFC337BA160>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightCancelledError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightCancelledError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightCancelledError' objects>, '__doc__': 'The operation was cancelled.', '__pyx_vtable__': <capsule object NULL at 0x000002441813A7E0>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002441813A7E0>'
