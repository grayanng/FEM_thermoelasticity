...
class FlightServerError(FlightError, __pyarrow_lib.ArrowException):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFC337BA3F0>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightServerError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightServerError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightServerError' objects>, '__doc__': 'A server error occurred.', '__pyx_vtable__': <capsule object NULL at 0x000002441813A810>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002441813A810>'
