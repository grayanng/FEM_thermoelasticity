# encoding: utf-8
# module _hashlib
# from C:\Users\akharin\AppData\Local\Programs\Python\Python39\DLLs\_hashlib.pyd
# by generator 1.147
...
openssl_md_meth_names = None # (!) real value is "frozenset({'sm3', 'whirlpool', 'ripemd160', 'blake2s', 'mdc2', 'sha3_256', 'sha384', 'sha1', 'md5-sha1', 'sha512', 'blake2b', 'md5', 'sha512_256', 'sha512_224', 'shake_256', 'sha3_512', 'sha3_384', 'sha256', 'shake_128', 'sha224', 'md4', 'sha3_224'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000217C8D57C70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000217C8D57C70>, origin='C:\\\\Users\\\\akharin\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python39\\\\DLLs\\\\_hashlib.pyd')"
